...
<12> If the system should allocate additional memory for the build. Note that this is limited by the value of the system `maxAdditionalMemory` (defaults to 4096).
